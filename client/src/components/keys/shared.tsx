...
export const PLATFORMS: { value: Platform; label: string; url: string; keyless?: boolean }[] = [
  ...
  { value: 'siliconflow', label: 'SiliconFlow Global (.com)', url: 'https://cloud.siliconflow.com/account/ak' },
  { value: 'siliconflow-cn', label: 'SiliconFlow China (.cn)', url: 'https://cloud.siliconflow.cn/account/ak' },
