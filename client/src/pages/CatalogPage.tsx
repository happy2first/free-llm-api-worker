...
type RecordEntry = { kind: string; platform: string; modelId: string; source: string; origin: string | null; extensions: Record<string, unknown>; values: Record<string, unknown>; revision: string; updatedAt: number | null; readOnly?: boolean }
